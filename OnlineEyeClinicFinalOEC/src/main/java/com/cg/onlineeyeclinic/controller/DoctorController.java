...
public class DoctorController {
	...
	@GetMapping("/validate_doctor/{username}/{password}")
	public ResponseEntity<Optional<Doctor>> validateDoctor(@PathVariable("username") String username, @PathVariable("password") String password){
		Optional<Doctor> doctor = doctorService.validateDoctor(username, password);
		return new ResponseEntity<>(doctor, HttpStatus.OK);
	}
